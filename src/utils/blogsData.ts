...
`
    },
    {
        ...
        blogHTML: `
<section class="blog-page px-4 py-8 max-w-5xl mx-auto">
    <h1 class="text-3xl sm:text-4xl md:text-5xl uppercase font-normal text-sea-green font-playfair-display mb-4">Sri Lanka’s Hill Country - A Journey Through Mist, Tea and Timeless Views</h1>
    <p class="mb-4 text-base md:text-lg text-gray-500">Sri Lanka’s hill country remains one of the island’s most graceful regions. Even travellers who have visited before often find something new each time. The landscape changes with the light, the weather shifts through soft layers of mist, and the towns still carry traces of their old colonial past. This edition looks at the heart of the highlands and why it continues to be a favourite for many visitors.</p>

    <h3 class="text-2xl md:text-3xl font-semibold mt-8 mb-4">Nuwara Eliya and Its Quiet Charm</h3>
    <p class="mb-4 text-base md:text-lg text-gray-500"">Often called Little England, Nuwara Eliya sits among sweeping tea fields and cool mountain breezes. The town itself still carries touches of its former era, with tidy gardens, red brick buildings and a peaceful lake at its centre.</p>
    <p class="mb-4 text-base md:text-lg text-gray-500">Travellers can take a gentle walk around Gregory Lake, stop at the local fruit markets or visit the historic post office that has become one of the most photographed spots in the region. The climate is noticeably cooler, which gives visitors a welcome break from the island’s warm lowlands.</p>

    <h3 class="text-2xl md:text-3xl font-semibold mt-8 mb-4">Tea Country and the Story Behind the Slopes</h3>
    <p class="mb-4 text-base md:text-lg text-gray-500">The tea estates surrounding the town create some of the most recognisable scenery in Sri Lanka. Rows of green bushes climb over the hills and workers can be seen moving through the fields in steady rhythm.</p>
    ...
    <p class="mb-4 text-base md:text-lg text-gray-500">The train journey from Nanu Oya toward Ella remains one of the most scenic stretches in the region. The ride weaves past cloud-topped peaks, deep valleys and small rural stations where life moves at an easy pace.</p>
    ...
    <p class="mb-4 text-base md:text-lg text-gray-500">The region offers a comfortable balance of sightseeing, gentle walks, cool weather and beautiful scenery. It suits guests who enjoy culture as much as nature, and it fits neatly into both short and extended itineraries.</p>
    <p class="mb-8 text-base md:text-lg text-gray-500">Nuwara Eliya and its surroundings continue to hold their place as one of the island’s most loved areas. The views remain timeless, and the atmosphere offers a sense of calm that is hard to find in many destinations today.</p>

    <p class="mb-8 text-center font-medium text-2xl text-gray-500 py-4 italic">Travel Nation will continue to share parts of Sri Lanka that carry both interest and character, helping you guide your clients toward journeys that feel meaningful and memorable.</p>
...
<section class="blog-page px-4 py-8 max-w-5xl mx-auto">
  ...
  <h1 class="text-3xl sm:text-4xl md:text-5xl uppercase font-normal text-sea-green font-playfair-display mb-4">The Maldives: A World of Islands, Light and Quiet Luxury</h1>

  <p class="mb-4 text-base md:text-lg text-gray-500">The Maldives has a way of slowing people down from the moment they arrive. The view from the plane window shows more sea than land, with islands scattered like small green circles across the blue. Each island has its own story and its own pace, and this is what makes the Maldives such a special part of our Travel Nation portfolio.</p>

  <h2 class="text-2xl md:text-3xl font-semibold mt-8 mb-4">A Nation Built on Coral Islands</h2>
  ...
  <p class="mb-4 text-base md:text-lg text-gray-500">For many travellers, the Maldives is an opportunity to reconnect with the sea. Snorkelling is possible straight from the beach on most islands. Guests can expect to see colourful reef fish, turtles and healthy corals in the shallower lagoons.</p>
  ...
  <p class="mb-4 text-base md:text-lg text-gray-500">Although the Maldives is known for luxury, not every island feels the same. Some resorts focus on wellness with quiet spa spaces, yoga pavilions and plant-based dining. Others are family friendly, with marine centres, kids’ clubs and safe lagoons that suit younger guests. There are also small boutique islands that offer a more personal approach, where guests feel as if they are staying on a private hideaway.</p>
  ...
  <p class="mb-8 text-base md:text-lg text-gray-500">The Maldives pairs smoothly with Sri Lanka because both destinations offer very different experiences in a short travel time. After exploring Sri Lanka’s culture, wildlife and scenery, the Maldives offers a quiet finish where guests can rest, swim and enjoy the rhythm of island life.</p>
  <p class="mb-8 text-center font-medium text-2xl text-gray-500 py-4 italic">Travel Nation continues to curate a collection of resorts and experiences across the Maldives that suit families, couples, divers and guests who want privacy. With new openings and renewed attention on sustainability, the Maldives remains one of the most inviting island destinations in the world.</p>
...
<section class="blog-page px-4 py-8 max-w-5xl mx-auto">
  ...
  <h1 class="text-3xl sm:text-4xl md:text-5xl uppercase font-normal text-sea-green font-playfair-display mb-4">Yala National Park: Where the Forest Opens to the Wild</h1>

  <p class="mb-4 text-base md:text-lg text-gray-500">Yala sits in the southeast of Sri Lanka and remains one of the country’s most impressive wildlife regions. The landscape shifts between scrub forest, open plains and rocky outcrops, with the Indian Ocean forming its eastern edge. For travellers who enjoy wildlife, this is one of the most rewarding places to explore.</p>

  <h2 class="text-2xl md:text-3xl font-semibold mt-8 mb-4">A Landscape Shaped by Water and Light</h2>
  ...
  <p class="mb-4 text-base md:text-lg text-gray-500">The park has a good balance of accessibility and wilderness. Roads are maintained well enough for comfortable jeep travel, yet the surroundings feel untouched. A typical visit includes two to four safaris spread across mornings and afternoons, which gives guests the best chance of seeing different animals.</p>
