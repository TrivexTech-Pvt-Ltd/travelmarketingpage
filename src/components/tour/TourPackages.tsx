...
const TourPackages = () => {
    ...
    return (
        <div className='px-5 md:px-8 xl:px-20 2xl:px-40 py-5 sm:py-12'>
            <h3 className='text-3xl md:text-4xl lg:text-5xl text-center pt-10 font-playfair-display text-sea-green font-normal mb-4 uppercase'>Be moved by the journey</h3>
            <p className='text-base lg:text-lg italic text-gray-500 text-center py-5'>Travel becomes memorable when it feels personal. With Travel Nation, your itinerary is curated from local insight and thoughtful care. <br /> You will step into places that travellers rarely see and gather stories that stay with you long after the bags are unpacked.</p>
