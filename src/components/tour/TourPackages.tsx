...
const TourPackages = () => {
  ...
  return (
    <div className="px-5 md:px-8 xl:px-10 2xl:px-20 4xl:px-96 py-5 sm:py-12">
      {/* Heading */}
      <motion.h3
        className="text-3xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl 2xl:text-5xl text-center pt-10 font-playfair-display text-sea-green font-normal mb-4 uppercase"
