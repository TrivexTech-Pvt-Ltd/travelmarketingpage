...
export default function InstaFeed() {
  return (
    <div className="max-w-7xl mx-auto px-4">
      ...
      <motion.h3
        className="text-sea-green text-3xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl 2xl:text-5xl uppercase font-normal font-playfair-display text-center py-5"
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
