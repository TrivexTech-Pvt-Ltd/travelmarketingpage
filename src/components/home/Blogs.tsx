...
const Blogs = () => {
  ...
  return (
    <div className="px-5 md:px-8 xl:px-20 2xl:px-60 3xl:px-96 py-10" id="blogs">
      {/* Heading */}
      <motion.h3
        className="text-sea-green text-3xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl 2xl:text-5xl uppercase font-normal text-center py-5 font-playfair-display"
        initial="hidden"
        whileInView="visible"
