...
const Intro = () => {
    return (
        <div className='flex flex-col px-5 md:px-20 xl:px-40 my-24 gap-y-4'>
            <h3 className='text-lg font-work-sans text-sea-green uppercase text-center font-medium'>Welcome to Travel Nation</h3>
            ...
            <div className='grid sm:grid-cols-2 xl:grid-cols-4 sm:gap-12 my-4'>
                {servicesData.map((item) => (
                    <div className='flex flex-col gap-y-2 justify-center items-center py-10' key={item.id}>
