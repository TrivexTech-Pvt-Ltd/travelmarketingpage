...
const Intro = () => {
  return (
    <div className="flex flex-col px-5 md:px-20 xl:px-56 my-12 max-sm:mb-0 md:my-24 gap-y-4">
      <h2 className="text-3xl sm:text-4xl md:text-5xl text-sea-green font-semibold text-center uppercase font-playfair-display">
        Crafting Journeys Beyond the Ordinary Across Sri Lanka & the Maldives.
      </h2>
      <p className="text-base lg:text-xl text-gray-500 text-center py-6">
      ...
      <h2 className="text-2xl sm:text-3xl md:text-4xl text-sea-green uppercase font-semibold text-center font-playfair-display">
      ...
      <p className="text-base lg:text-xl text-gray-500 text-center pb-3">
