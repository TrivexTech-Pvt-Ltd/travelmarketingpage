...
const Intro = () => {
  return (
    <div className="flex flex-col px-5 md:px-20 xl:px-40 my-12 md:my-24 max-md:mb-10 gap-y-4">
      ...
      <motion.p
        className="text-base sm:text-lg md:text-xl text-gray-500 text-center py-6"
        initial={{ opacity: 0, y: -50 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.3 }}
        transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
      ...
      <motion.p
        className="text-base sm:text-lg md:text-xl text-gray-500 text-center pt-6"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.3 }}
        transition={{ duration: 0.8, ease: "easeOut", delay: 0.4 }}
      ...
      <motion.p
        className="text-base sm:text-lg md:text-xl text-gray-500 text-center pb-3"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.3 }}
        transition={{ duration: 0.8, ease: "easeOut", delay: 0.6 }}
      ...
      <div className="flex justify-center">
        <Link
          ...
          text-white bg-sea-green py-3 px-6 sm:py-4 sm:px-8 
