        ...
        <div className='flex flex-col md:pb-20'>
            <div className='grid grid-cols-1 md:grid-cols-2'>
                ...
                <div className='bg-soft-beige p-6 flex justify-center items-center flex-col md:px-28'>
                    <div className='space-y-6 md:space-y-10'>
                        <h3 className='text-sea-green text-4xl md:text-5xl font-semibold font-playfair-display'>Luxury Travel in the <br /> Maldives</h3>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
                <div className='bg-soft-beige p-6 flex md:justify-center md:items-center flex-col md:px-28'>
                    <div className='space-y-6 md:space-y-10'>
                        <h3 className='text-sea-green text-4xl md:text-5xl font-semibold font-playfair-display'>Discover the Beauty <br /> of Sri Lanka</h3>
