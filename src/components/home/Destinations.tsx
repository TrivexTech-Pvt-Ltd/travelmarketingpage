  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        {/* TEXT */}
        <motion.div
          className="order-2 lg:order-2 bg-soft-beige p-6 flex justify-center items-center flex-col lg:px-12 xl:px-20"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
        ...
        >
          <div className="space-y-6 md:space-y-10 max-xl:mb-5">
            ...
            <motion.p
              className="text-base sm:text-lg md:text-xl text-gray-500 leading-7"
              variants={fadeInUp}
              transition={{ duration: 0.6, delay: 0.25 }}
            >
              The island of stories, ancient heritage, and untamed wilderness.
            ...
            >
              <Link
                ...
                text-white w-fit flex items-center gap-x-2 rounded-md bg-sea-green 
                py-3 px-6 sm:py-4 sm:px-8 border transition-all duration-300 
                hover:bg-transparent border-sea-green hover:text-sea-green 
