...
//             <h3 className="text-sea-green text-3xl sm:text-4xl md:text-5xl uppercase font-normal font-playfair-display">
//               Discover the Beauty <br /> of Sri Lanka
//             </h3>
//             <p className="text-base lg:text-xl text-gray-500 leading-7">
...
const Destinations = () => {
  return (
    <div className="flex flex-col">
      {/* SRI LANKA SECTION */}
      <div className="grid grid-cols-1 lg:grid-cols-2">
        {/* IMAGE FIRST in mobile, LEFT in desktop */}
        ...
        {/* TEXT SECOND in mobile, RIGHT in desktop */}
        <div className="order-2 lg:order-2 bg-soft-beige p-6 flex md:justify-center md:items-center flex-col lg:px-12 xl:px-20">
          <div className="space-y-6 md:space-y-10 max-xl:mb-5">
            <h3 className="text-sea-green text-3xl sm:text-4xl md:text-5xl uppercase font-normal font-playfair-display">
              Discover the Beauty <br /> of Sri Lanka
            </h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="order-2 lg:order-1 bg-soft-beige p-6 flex justify-center items-center flex-col lg:px-12 xl:px-20">
          <div className="space-y-6 md:space-y-10 max-xl:mb-5">
            <h3 className="text-sea-green text-3xl sm:text-4xl md:text-5xl uppercase font-normal font-playfair-display">
              Luxury Travel in the <br /> Maldives
            </h3>
