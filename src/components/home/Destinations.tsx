...
const Destinations = () => {
    return (
        <div className='flex flex-col md:pb-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
                <div className='bg-soft-beige p-6 flex justify-center items-center flex-col px-28'>
                    <div className='space-y-10'>
                        <h3 className='text-sea-green text-5xl font-semibold font-work-sans'>Discover the Beauty <br /> of Sri Lanka</h3>
