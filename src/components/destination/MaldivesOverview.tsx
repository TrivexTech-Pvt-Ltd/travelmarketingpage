    ...
    <>
      <div className="flex justify-center items-center max-w-7xl mx-auto my-8 sm:my-16">
        <div className="text-center">
          <h3 className='text-sea-green text-3xl sm:text-4xl md:text-5xl font-semibold font-playfair-display my-5'>Welcome to the Maldives</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
        <div className="flex justify-center items-center bg-soft-beige h-full lg:px-16">
          <div className='pr-2'>
            <p className='text-shadow-wash text-lg uppercase font-medium'>Resorts & Villas</p>
            <h3 className='text-shadow-wash text-3xl sm:text-4xl md:text-5xl font-semibold font-playfair-display my-5'>Your Private Haven</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
        ...
        <div className="flex justify-center items-center bg-soft-beige h-full lg:px-16">
          <div className='pr-2'>
            <p className='text-shadow-wash text-lg uppercase font-medium'>Diving & Marine Life</p>
            <h3 className='text-shadow-wash text-3xl sm:text-4xl md:text-5xl font-semibold font-playfair-display my-5'>Beneath the Blue</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
        <div className="flex justify-center items-center bg-soft-beige h-full lg:px-16">
          <div className='pr-2'>
            <p className='text-shadow-wash text-lg uppercase font-medium'>Romance & Honeymoons</p>
            <h3 className='text-shadow-wash text-3xl sm:text-4xl md:text-5xl font-semibold font-playfair-display my-5'>Where Love Meets the Horizon</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
        ...
        <div className="flex justify-center items-center bg-soft-beige h-full lg:px-16">
          <div className='pr-2'>
            <p className='text-shadow-wash text-lg uppercase font-medium'>Atolls & Islands</p>
            <h3 className='text-shadow-wash text-3xl sm:text-4xl md:text-5xl font-semibold font-playfair-display my-5'>Each with Its Own Soul</h3>
      ...
      <div className="my-16 px-5 lg:px-20">
        <h4 className="font-semibold text-xl my-2">The Maldives is more than a holiday, it is an experience of stillness, elegance, and connection.</h4>
