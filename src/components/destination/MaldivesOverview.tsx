        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center max-w-7xl mx-auto my-10 sm:my-20">
          ...
          <div className="flex justify-center items-center bg-soft-beige h-full order-1 lg:order-2">
            <div className='p-6 sm:p-12'>
              ...
              <p className='text-sm sm:text-base md:text-lg text-gray-500 leading-7'>At Travel Nation, we partner with handpicked resorts that cater to all types of travelers — from honeymooners seeking romance and privacy to families looking for a fun-filled escape. Each resort offers personalized service, gourmet dining, and private pools, along with spa retreats set against breathtaking ocean backdrops.</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className='flex flex-col gap-y-6 sm:pl-8 py-4'>
                <div className='flex gap-x-4'>
                  <div className='w-8 h-8'>
                    <IoCheckmarkDoneSharp className="text-sea-green  whitespace-nowrap text-lg" />
                  </div>
