...
//         <div className="flex justify-center items-center bg-soft-beige h-full order-2 lg:order-1 lg:px-16">
//           <div className="pr-2">
//             <h3 className="text-sea-green text-3xl sm:text-4xl md:text-5xl font-normal uppercase font-playfair-display my-5">
//               Resorts <span className="font-libreBaskerville">&</span> Villas
//             </h3>
//             <p className="text-shadow-wash text-base lg:text-xl uppercase font-medium my-5">
//               Your Private Haven
//             </p>
//             <p className="text-sm lg:text-lg text-gray-500 mb-6 sm:mb-8 leading-7 sm:leading-8">
...
//         <div className="flex justify-center items-center bg-soft-beige h-full order-2 lg:order-2 lg:px-16">
//           <div className="pr-2">
//             <h3 className="text-sea-green text-3xl sm:text-4xl md:text-5xl font-normal uppercase font-playfair-display my-5">
