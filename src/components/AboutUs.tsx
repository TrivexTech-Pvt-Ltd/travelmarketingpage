...
const AboutUs = () => {
  return (
    <>
      <ImageSlider heroData={aboutUsData} height="h-96 lg:h-full xl:h-[680px] 4xl:h-[1080px]" />
      ...
      <div className="flex flex-col justify-center items-center max-w-7xl mx-auto max-sm:px-4 py-4 sm:py-10">
        ...
        <p className="text-sm lg:text-lg text-gray-500 leading-7 text-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
        ...
        <Image
          ...
          width={500}
          alt="maldives"
          className="w-full h-96 lg:h-full xl:h-[680px] 4xl:h-[1080px] order-1 lg:order-1"
        />

        {/* TEXT SECOND ON MOBILE */}
        <div className="bg-soft-beige p-6 flex justify-center items-center flex-col lg:px-12 h-full order-2 lg:order-2">
          <div className="space-y-6 md:space-y-10">
            ...
            <p className="text-sm lg:text-lg text-gray-500 leading-7">
              ...
              to leave a lasting impression. These islands are more than
              destinations; they are living experiences waiting to be
            ...
            <p className="text-sm lg:text-lg text-gray-500 leading-7">
              ...
              strive to protect and preserve the natural environment, promoting
              sustainable travel practices that ensure these places remain as
              vibrant and beautiful for generations to come.
            </p>
            <p className="text-sm lg:text-lg text-gray-500 leading-7">
              ...
              celebration of people, nature, and heritage — a positive footprint
              left behind wherever you go.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
        ...
        <Image
          ...
          width={500}
          alt="maldives"
          className="w-full h-96 lg:h-full xl:h-[680px] 4xl:h-[1080px] order-1 lg:order-2"
        />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
        ...
        <div className="bg-soft-beige p-6 flex justify-center items-center flex-col lg:px-12 h-full order-2 lg:order-1">
          <div className="space-y-6 md:space-y-10">
            ...
            <p className="text-sm lg:text-lg text-gray-500 leading-7">
              ravel Nation is guided by a simple philosophy: listen first,
