  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center max-w-7xl mx-auto max-sm:px-4 py-4 sm:py-10">
        <h1 className="text-sea-green text-3xl sm:text-4xl md:text-6xl font-semibold font-playfair-display my-5">
      ...
      <div className="flex flex-col my-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="bg-soft-beige p-6 flex md:justify-center md:items-center flex-col lg:px-8 2xl:px-28 order-2 lg:order-1">
            <div className="space-y-6 md:space-y-10 max-xl:mb-5">
              <h3 className="text-shadow-wash text-3xl sm:text-4xl md:text-5xl font-semibold font-playfair-display my-5">
                Our Mission
              </h3>
              <p className="text-sm sm:text-base text-gray-500 leading-7">
                ...
                Lanka. We believe in curating journeys that blend luxury,
                adventure, culture, and nature in perfect harmony, ensuring
                every trip is as unique as our clients
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-10">
                {ourMissionData.map((item) => (
                  ...
                  >
                    ...
                    <h4 className="text-lg sm:text-xl font-semibold text-shadow-wash">
                      {item.title}
                    </h4>
      ...
      <div className="flex flex-col justify-center items-center max-w-7xl mx-auto pb-10 sm:pb-20">
        ...
        <p className="text-sm sm:text-base text-gray-500 leading-7 text-center max-sm:px-4">
          Rooted in integrity and inspired by exploration, our values shape the
          way we curate every trip — ensuring each traveler experiences the
          world with comfort, purpose, and wonder.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-10 px-5 sm:px-10 py-6">
          {ourValuesData.map((item) => (
            ...
            >
              ...
              <h4 className="text-lg sm:text-xl font-semibold text-sea-green">
                {item.title}
              </h4>
              <p className="text-center text-gray-500 text-sm">
                {item.description}
