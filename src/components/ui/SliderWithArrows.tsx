...
//   // Always have a stable lightbox array to prevent hook order issues
//   const lightboxSources = useMemo(() => {
//     return images.length > 0 ? images.map((img) => img.src) : [""];
//   }, [images]);

//   // Initialize Swiper navigation after refs are attached
//   useEffect(() => {
//     if (
//       swiperRef.current &&
